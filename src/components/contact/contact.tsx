...
const Contact: React.FC = () => {
  ...
  return (
    <div className="py-20 md:py-10">
      <div
        className="flex justify-center items-center mt-20 bg-[#242323] text-color-light rounded-xl"
        id="contact">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-color-light gap-20 flex flex-col">
              <div>
                ...
                <p>lets make your project become a reality</p>
              </div>
              ...
              <div>
                <form onSubmit={sendEmail} className="flex flex-col text-color">
                  ...
                  <textarea
                    ...
                    className="border-[1px] text-black border-gray-400 text-color focus:outline-none focus:ring-black focus:border-black w-full p-2 py-6 rounded-b-lg"
                    required></textarea>
                  <input
                    type="submit"
                    value={loading ? "Sending..." : "Send Message"}
                    className={`btn border-none hover:bg-[#9897a4] focus:outline-none focus:ring-black focus:border-black text-color-dark bg-color-light btn-primary mt-5 bg-[#4b4a4e] p-2 rounded-md ${
                      loading ? "bg-gray-400" : ""
                    }`}
                    disabled={loading}
                  />
